...
public class SingleLetterDisplaySimple extends Application {
    ...
    public static int textCenterX = 10;
    public static int textCenterY = 10;
        ...
        public void handle(KeyEvent keyEvent) {
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                if (characterTyped.length() > 0 /*&& characterTyped.charAt(0) != 8*/) {
                    ...
                    wordToDisplay = wordToDisplay + characterTyped;
                    displayText.setText(wordToDisplay);
                    textCenterX = textCenterX + 5;
                    keyEvent.consume();
                }
